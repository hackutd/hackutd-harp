...
// index.html cannot import TypeScript, so the brand values it needs are
// injected here from the same object that builds the PWA manifest below.
// Keeping both on one source is what stops the tab title and the browser
// theme colour drifting apart from the installed app's.
